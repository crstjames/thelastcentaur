/**
 * This is an example component showing how the map should be styled
...
const MapExample: React.FC<MapProps> = ({ playerPosition = "0,0", visitedTiles = new Set() }) => {
...
// Example usage:
// <MapExample playerPosition="1,2" visitedTiles={new Set(["0,0", "1,0", "0,1", "1,1", "1,2"])} />
